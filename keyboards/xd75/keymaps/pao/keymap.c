...
#define Kc_NMFN LT(LAYER_NUMFN, KC_ENTER)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_QWERTY] = {
        ...
        {KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,Kc_SFSL ,Kc_SFBS ,KC_P1   ,KC_P2   ,KC_P3  },
        {KC_GRV  ,KC_LGUI ,KC_LCTL ,KC_LALT ,Kc_LOWR ,KC_ENT  ,KC_SPC  ,Kc_RASE ,KC_LALT ,KC_RCTL ,Kc_GUSP ,KC_DEL  ,KC_P0   ,Kc_NMFN ,KC_PDOT},
    },
